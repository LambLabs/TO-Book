...
\def\bookauthors{Jakub Stankowski, Agnieszka Wardzińska, Krzysztof Wegner}
...
\input{FirstPage.tex}
%====================================================
\input{01_opor_zastepczy/01_opor_zastepczy.tex}
\input{02_zrodla/02_zrodla.tex}
\input{03_prawa_kirchhoffa/03_prawa_kirchhoffa.tex}
%\input{04_metoda_wezlowa/04_metoda_wezlowa.tex}
\input{05_metoda_oczkowa/05_metoda_oczkowa.tex}
\input{06_thevenin_norton/06_thevenin_norton.tex}
\input{07_moc/07_moc.tex}
\input{08_superpozycja/08_metoda_superpozycji.tex}
\input{09_uklady_nieliniowe/09_uklady_nieliniowe.tex}
\input{10_impedancja_zastepcza/10_impedancja_zastepcza.tex}
\input{11_metoda_oczkowa_wezlowa_AC/11_metoda_oczkowa_wezlowa_AC.tex}
\input{12_moc_AC/12_moc_AC.tex}
